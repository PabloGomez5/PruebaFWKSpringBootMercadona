...
CREATE TABLE `PRODUCTO` (
  ...
  `FECHA_BAJA_PRODUCTO` TIMESTAMP(6) NULL DEFAULT NULL,
   PRIMARY KEY (`ID`),
   CONSTRAINT `FK_CODIGO_PROVEDOR`FOREIGN KEY (`CODIGO_PROVEDOR`) REFERENCES `PROVEDOR` (`CODIGO`) ENABLE,
   CONSTRAINT `FK_ID_DESTINO`FOREIGN KEY (`ID_DESTINO`) REFERENCES `DESTINO` (`ID`) ENABLE,
);
...
INSERT INTO `PROVEDOR` (`codigoProvedor`, `nombre`)
VALUES
	(8437008,'Hacendado'),
